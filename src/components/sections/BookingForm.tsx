...
_Mohon konfirmasi ketersediaan jadwal slot mekanik._`;
  ...
  return (
    <section id="booking" className="relative py-24 bg-brand-dark overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.div
          ...
          className="glass-card-no-hover p-6 sm:p-10 rounded-3xl border border-white/10 relative overflow-hidden"
        >
          {isSuccess ? (
            <motion.div
            ...
            >
              <div className="w-16 h-16 rounded-full bg-brand-red/10 border border-brand-red/35 flex items-center justify-center mb-6 shadow-[0_0_20px_rgba(220,38,38,0.2)]">
                <CheckCircle2 className="w-8 h-8 text-brand-red-light" />
              </div>
              <h3 className="font-poppins font-bold text-2xl text-white mb-3">
                Booking Berhasil Terkirim!
              </h3>
              <p className="font-inter text-sm text-brand-gray/95 max-w-md mx-auto mb-8 leading-relaxed">
              ...
              <button
                ...
                className="px-6 py-2.5 rounded-lg border border-white/10 hover:border-brand-red/35 bg-white/5 hover:bg-brand-red/10 text-white hover:text-brand-red-light font-poppins text-sm font-semibold transition-all duration-300"
              >
                Buat Booking Baru
              </button>
            </motion.div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col">
                  <label className="font-poppins font-semibold text-xs uppercase tracking-wider text-brand-silver/90 mb-2 flex items-center gap-1.5">
                    <User className="w-3.5 h-3.5 text-brand-red-light" />
                    Nama Lengkap
                  </label>
                  <input
                    type="text"
                  ...
                  />
                  {errors.name && (
                    <span className="text-brand-red-light text-xs mt-1.5 font-medium">
                      {errors.name.message}
                    </span>
                  )}
                </div>
                ...
                <div className="flex flex-col">
                  <label className="font-poppins font-semibold text-xs uppercase tracking-wider text-brand-silver/90 mb-2 flex items-center gap-1.5">
                    <Car className="w-3.5 h-3.5 text-brand-red-light" />
                    Jenis / Tipe Mobil
                  </label>
                  <input
                    type="text"
                ...
                <div className="flex flex-col">
                  <label className="font-poppins font-semibold text-xs uppercase tracking-wider text-brand-silver/90 mb-2 flex items-center gap-1.5">
                    <Calendar className="w-3.5 h-3.5 text-brand-red-light" />
                    Tanggal Servis
                  </label>
                  <input
                    type="date"
                ...
                <div className="flex flex-col">
                  ...
                  <select
                    ...
                    className="glass-input px-4 py-3.5 rounded-xl text-sm w-full"
                  >
                    <option value="" className="bg-brand-dark">Pilih jam...</option>
                    <option value="08:00 - 10:00" className="bg-brand-dark">08:00 - 10:00</option>
                    <option value="10:00 - 12:00" className="bg-brand-dark">10:00 - 12:00</option>
                    <option value="13:00 - 15:00" className="bg-brand-dark">13:00 - 15:00</option>
                    <option value="15:00 - 17:00" className="bg-brand-dark">15:00 - 17:00</option>
                  </select>
                  {errors.time && (
                    <span className="text-brand-red-light text-xs mt-1.5 font-medium">
                      {errors.time.message}
                ...
                <div className="flex flex-col sm:col-span-2">
                  <label className="font-poppins font-semibold text-xs uppercase tracking-wider text-brand-silver/90 mb-2 flex items-center gap-1.5">
                    <HelpCircle className="w-3.5 h-3.5 text-brand-red-light" />
              ...
              <div className="pt-4">
                <button
                  ...
                  className="w-full py-4 rounded-xl bg-brand-red hover:bg-brand-red-light font-poppins font-bold text-base text-white transition-all duration-300 shadow-[0_4px_25px_rgba(220,38,38,0.35)] relative overflow-hidden group flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>
