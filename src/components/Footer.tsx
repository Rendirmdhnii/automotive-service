...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#080809] border-t border-white/5 pt-16 pb-8 z-20 overflow-hidden">
      {/* Background Graphic Lines */}
      <div className="absolute bottom-0 right-0 w-80 h-80 rounded-full bg-brand-red/5 blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-16 pb-12 border-b border-white/5">
          ...
          <div className="lg:col-span-4 flex flex-col">
            ...
            >
              <div className="w-10 h-10 rounded-lg bg-brand-red flex items-center justify-center transition-all duration-300 group-hover:scale-105 group-hover:rotate-12 shadow-[0_0_15px_rgba(220,38,38,0.4)]">
                <Wrench className="w-5 h-5 text-white" />
              </div>
              <div className="flex flex-col">
                <span className="font-poppins font-extrabold text-xl tracking-wider text-white">
                  IPIN <span className="text-brand-red">MOTOR</span>
                </span>
                <span className="text-[9px] font-medium uppercase tracking-[0.2em] text-brand-gray -mt-1">
                  Premium Auto Service
                </span>
              </div>
            </Link>

            <p className="font-inter text-xs text-brand-gray/95 leading-relaxed mb-6">
            ...
            <div className="flex flex-col gap-1 mb-6">
              ...
              <span className="font-poppins font-semibold text-[10px] text-brand-red-light uppercase tracking-[0.2em]">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                className="w-9 h-9 rounded-lg bg-white/5 hover:bg-brand-red border border-white/10 hover:border-brand-red flex items-center justify-center text-brand-silver hover:text-white transition-all duration-300"
              ...
              >
                {/* Custom TikTok SVG for precision styling */}
          ...
          <div className="lg:col-span-3 flex flex-col md:pl-6">
            <h4 className="font-poppins font-bold text-sm text-white tracking-wider uppercase mb-6 border-l-2 border-brand-red pl-2.5">
              Menu Cepat
            </h4>
              ...
              {[
                ...
                <li key={idx}>
                  <a
                    ...
                    className="font-inter text-xs text-brand-gray/90 hover:text-brand-red-light transition-colors"
                  >
                    {link.name}
                  </a>
                </li>
          ...
          <div className="lg:col-span-2 flex flex-col">
            ...
            <div className="flex flex-col gap-4 font-inter text-xs text-brand-gray/90">
              <div className="flex items-start gap-2.5">
                <Clock className="w-4.5 h-4.5 text-brand-red-light flex-shrink-0 mt-0.5" />
                <div className="flex flex-col">
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-brand-red-light font-medium">Bengkel Libur</span>
                  <span className="text-[10px] text-brand-gray/70 italic mt-0.5">Towing 24 Jam tetap Siaga</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-3 flex flex-col">
            ...
            <ul className="space-y-4 font-inter text-xs text-brand-gray/90">
              <li className="flex items-start gap-2.5">
                <MapPin className="w-4.5 h-4.5 text-brand-red-light flex-shrink-0 mt-0.5" />
                <span>Sidoarjo, Jawa Timur, Indonesia</span>
              </li>
              <li className="flex items-start gap-2.5">
                <Phone className="w-4.5 h-4.5 text-brand-red-light flex-shrink-0 mt-0.5" />
                <div className="flex flex-col">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between pt-8 text-center sm:text-left">
          <p className="font-inter text-[11px] text-brand-gray/80">
            &copy; {new Date().getFullYear()} IPIN MOTOR. Hak Cipta Dilindungi Undang-Undang.
          </p>
          <p className="font-inter text-[10px] text-brand-gray/70 mt-2 sm:mt-0">
