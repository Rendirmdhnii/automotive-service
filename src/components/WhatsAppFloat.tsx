  ...
  return (
    ...
    >
      <a
        ...
        className="flex items-center justify-center h-14 w-14 group-hover:w-auto px-0 group-hover:px-5 rounded-full bg-emerald-500 hover:bg-emerald-600 text-white shadow-lg shadow-emerald-500/30 hover:scale-110 transition-all duration-300 relative"
      ...
      >
        ...
        {/* WhatsApp Icon (Perfect Centering) */}
        ...
        <span className="max-w-0 overflow-hidden whitespace-nowrap group-hover:max-w-[200px] transition-all duration-300 font-poppins font-bold text-[10px] sm:text-xs uppercase tracking-wider text-white ml-0 group-hover:ml-2">
